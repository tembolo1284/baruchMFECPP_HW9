...
{ // Unary minus
	...
	/// BUG BUG DAMN IT	result[i] = - result[i]; <-- appreciate the passion :D
	result[i] = - (*this)[i];
...
template <class V, class I, class S>
Vector<V, I, S> Vector<V, I, S>::operator - () const { // Unary minus
...
template <class V, class I, class S>
Vector<V, I, S> operator * (const Vector<V, I, S>& v, const V& a) { // Multiply to every element by a
...
template <class V, class I, class S>
Vector<V, I, S>& Vector<V, I, S>::operator += (const Vector<V, I, S>& v) { // Add the elements
...
template <class V, class I, class S>
Vector<V, I, S>& Vector<V, I, S>::operator -= (const Vector<V, I, S>& v) { // Subtract the elements
	for (I i=this->MinIndex(); i<=this->MaxIndex(); i++) 
			(*this)[i] = (*this)[i] - v[i];
...
template <class V, class I, class S>
Vector<V, I, S>& Vector<V, I, S>::operator *= (const Vector<V, I, S>& v) { // Multiply the elements
